...
with open(REPO_ROOT / ".agents" / "teamwork_preview_explorer_survey_fe" / "unmounted_details.json", "w", encoding="utf-8") as out:
    json.dump(unmounted_details, out, indent=2, ensure_ascii=False)

print(f"Dumped {len(unmounted_details)} unmounted component details.")
