...
### 1. Offensive Positions (RPG)

A concise overview of offensive RPG features, including quarterback, running back, wide receiver, tight end, offensive tackle, guard, and center enhancements. Each feature provides strategic depth, performance boosts, or tactical options without extensive table detail. |
...
| **Defensive Tackle** | `Grave Digger` | **Physics**: Expands "Pile Up" radius, blocks two gaps. | Level 12 + Weight > 320lbs | Frees LBs. |
| **Defensive Tackle** | `Interior Disruptor` | **Passive**: 15% chance to shed block on QB pressure. | Level 15 | Adds interior pressure. |
| **Linebacker** | `Field Commander` | **Vision**: Expands defense fog of war. | Level 18 + Awareness > 95 | Prevents surprise formations. |
| **Linebacker** | `Lurker` | **Jump**: Super jumps to intercept 5‑10 yd passes. | Level 10 + Jump > 90 | Stops intermediate routes. |
| **Cornerback** | `Island King` | **Isolation**: +5 stats without safety help. | Level 20 + Man Cov > 95 | Enables aggressive blitzing. |
| **Cornerback** | `Route Jumper` | **Predict**: 50% bonus on 4th repeat route. | Level 12 + Play Rec > 85 | Discourages route repetition. |
| **Safety** | `Hit Stick Master` | **Physics**: Tackles 20% chance to cause incompletion. | Level 8 + Hit Power > 90 | Increases turnover risk. |
| **Safety** | `Robber Role` | **AI**: Adds "Robber" zone to trap crossing routes. | Level 14 | Confuses QBs. |

### 3. Special Teams Positions

| Position | Feature Name | Mechanism | XP Cost / Requirement | Positional Impact |
| Feature | Name | Mechanic | Level | Impact |
| :----------------- | :-------------- | :--------------------------------------------------------- | :------------------ |
| **Defensive Line** | **50-79,90-99** | Arm Braces, Neck Roll, Facemask, Gloves, Club Cast. | Intimidating. |
| **Linebacker** | **0-59,90-99** | Neck Roll, Dark Visor, Sleeves, Gloves, Turf Tape. | "Gladiator" style. |
| **Defensive Back** | **0-49** | Comp Sleeves, Leg Sleeves, Mirror Visor, Towel, Backplate. | Sleek, aerodynamic. |

### 3. Special Teams Identity

| Position            | Jersey         | Accessories                                    | Note             |
| :------------------ | :------------- | :--------------------------------------------- | :--------------- |
| **Kicker / Punter** | **0-49,90-99** | Facemask, Soccer Cleats, Wristband, Thigh Pad. | Minimal padding. |
