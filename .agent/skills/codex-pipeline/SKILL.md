---
name: codex-pipeline
description: Execute the autonomous 6-stage cognitive engineering loop (Research, Synthesize, Write, Review, Critique, Advance) for any feature or subsystem per task-list-template.md.
---
