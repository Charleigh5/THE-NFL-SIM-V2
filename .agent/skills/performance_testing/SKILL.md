...
description: Instructions and commands for running performance benchmarks, MCP tool call benchmarks, and load tests.
---

# Performance Testing

This skill describes how to run the performance benchmarks and load tests for the NFL Sim Engine.
