---
name: update-player-dossier
description: Update the Player System Dossier (PLAYER_SYSTEM_DOSSIER.md) when player mechanics, attributes, progression, or injury systems change.
---

# Update Player System Dossier

Use this skill whenever you modify player-related systems to keep the `PLAYER_SYSTEM_DOSSIER.md` up to date.

## When to Run This Skill

Execute this skill after changes to any of these files:
