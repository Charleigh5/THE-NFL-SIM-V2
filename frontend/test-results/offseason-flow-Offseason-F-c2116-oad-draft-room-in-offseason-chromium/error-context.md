...
- generic [ref=e3]:
  ...
  - main [ref=e100]:
    - generic [ref=e103]:
      - heading "404 - Page Not Found" [level=1] [ref=e104]
      - paragraph [ref=e105]: The page you're looking for doesn't exist.
  - button "Mission Control" [ref=e107] [cursor=pointer]: ⚡
  - button "Open music player" [ref=e109] [cursor=pointer]:
    - img [ref=e110]
```