...
- generic [ref=e3]:
  ...
  - main [ref=e100]:
    - generic [ref=e103]:
      - heading "Unexpected Error" [level=1] [ref=e104]
      - paragraph [ref=e105]: prospects is not iterable
      - group [ref=e106]:
        - generic "Stack Trace" [ref=e107]
  - button "Mission Control" [ref=e109] [cursor=pointer]: ⚡
  - button "Open music player" [ref=e111] [cursor=pointer]:
    - img [ref=e112]
```