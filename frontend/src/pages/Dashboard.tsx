...
import { Activity, Calendar, ChevronRight, Play } from "lucide-react";
          ...
          <div className="flex-1 overflow-hidden relative">
            ...
            <div className="space-y-2 opacity-60">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="flex justify-between items-center py-2 border-b border-white/5 font-mono text-xs"
                >
