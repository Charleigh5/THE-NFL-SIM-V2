  ...
  return (
    <div className="space-y-6" data-testid="front-office-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div
          className="lg:col-span-2 glass-panel p-6 rounded-xl border border-white/5 min-h-[500px]"
          data-testid="roster-section"
        >
          <h2 className="text-xl font-bold text-white mb-4">Active Roster ({roster.length})</h2>
          <div
            className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 max-h-[600px] overflow-y-auto pr-2"
      ...
      {selectedPlayer && (
        ...
        >
          <div
            className="bg-slate-900 border border-white/10 rounded-xl p-6 max-w-md w-full relative shadow-2xl"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 p-4 rounded-lg border border-white/5">
                ...
                <p className="text-2xl font-mono text-white" data-testid="player-speed">
                  {selectedPlayer.speed ?? "N/A"}
                </p>
              </div>
              <div className="bg-white/5 p-4 rounded-lg border border-white/5">
                <p className="text-gray-400 text-xs uppercase tracking-wider mb-1">Strength</p>
                <p className="text-2xl font-mono text-white" data-testid="player-strength">
                  {selectedPlayer.strength ?? "N/A"}
                </p>
              </div>
            </div>
          </div>
