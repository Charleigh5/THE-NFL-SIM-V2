...
test.describe.serial("Trade System E2E", () => {
  ...
  test("should negotiate a trade and submit offer", async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="offered-zone"]')).toContainText("Murray", { timeout: 10000 });
    ...
    await expect(page.locator('[data-testid="offered-zone"]')).not.toContainText("Murray", { timeout: 10000 });
  });
