...
test.describe("Visual Regression Tests", () => {
  // Skip visual regressions in CI because baseline snapshots are not available/reliable
  test.skip(!!process.env.CI, "Visual regression snapshots not committed yet");
