...
class StadiumModel(BaseModel):
    ...
    noise_rating: int = 70  # 0-100 scale (KC/SEA/DEN = 90)
...
STADIUM_DB = {
    ...
    "ARROWHEAD": StadiumModel(rank=4, name="Arrowhead Stadium", team_ids=["KC"], capacity=76416, year_built=1972, roof_type="Open-Air", surface="Grass", cost_billions=0.043, features=["Loudest Stadium Record", "Sea of Red"], altitude=800, noise_rating=95),
    "EMPOWER": StadiumModel(rank=5, name="Empower Field at Mile High", team_ids=["DEN"], capacity=76125, year_built=2001, roof_type="Open-Air", surface="Grass", cost_billions=0.4, features=["Altitude Advantage", "Thundering Floors"], altitude=5280, noise_rating=85),
    ...
    "SUPERDOME": StadiumModel(rank=7, name="Caesars Superdome", team_ids=["NO"], capacity=73208, year_built=1975, roof_type="Fixed Dome", surface="Turf", cost_billions=0.134, features=["Largest Fixed Dome", "Super Bowl Host"], altitude=7, noise_rating=90),
    ...
    "HIGHMARK": StadiumModel(rank=9, name="Highmark Stadium", team_ids=["BUF"], capacity=71608, year_built=1973, roof_type="Open-Air", surface="Turf", cost_billions=0.022, features=["Windy Conditions", "Bills Mafia"], altitude=700, noise_rating=88),
    "MTBANK": StadiumModel(rank=10, name="M&T Bank Stadium", team_ids=["BAL"], capacity=71008, year_built=1998, roof_type="Open-Air", surface="Grass", cost_billions=0.22, features=["Purple Lights", "Ravens Walk"], altitude=50, noise_rating=87),
    ...
    "LUMEN": StadiumModel(rank=16, name="Lumen Field", team_ids=["SEA"], capacity=69000, year_built=2002, roof_type="Partial Coverage", surface="Turf", cost_billions=0.43, features=["12th Man Acoustics", "Hawk's Nest"], altitude=20, noise_rating=92),
    ...
    "USBANK": StadiumModel(rank=23, name="U.S. Bank Stadium", team_ids=["MIN"], capacity=66655, year_built=2016, roof_type="Fixed Translucent", surface="Turf", cost_billions=1.1, features=["ETFE Roof", "Glass Doors", "Viking Ship"], altitude=850, noise_rating=90),
