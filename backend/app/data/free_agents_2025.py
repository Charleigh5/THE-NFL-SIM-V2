...
FREE_AGENT_SIGNINGS_2025: list[FreeAgentSigning] = [
    ...
    FreeAgentSigning(
        ...
        previous_team="PHI",
        contract_years=4,
        contract_total=104_000_000,
        contract_gtd=65_000_000,
        apy=26_000_000,
        age=26,
        overall_rating=88,
        strength=92,
        awareness=85,
        primary_attribute=90,  # block_shed
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="MIN",
        contract_years=3,
        contract_total=100_500_000,
        contract_gtd=63_000_000,
        apy=33_500_000,
        age=28,
        overall_rating=82,
        speed=78,
        awareness=80,
        primary_attribute=85,  # throw_power
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="PIT",
        contract_years=4,
        contract_total=82_000_000,
        contract_gtd=50_000_000,
        apy=20_500_000,
        age=26,
        overall_rating=83,
        strength=88,
        awareness=82,
        primary_attribute=85,  # pass_block
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="PHI",
        contract_years=4,
        contract_total=76_400_000,
        contract_gtd=45_000_000,
        apy=19_100_000,
        age=28,
        overall_rating=86,
        speed=88,
        strength=83,
        primary_attribute=87,  # pass_rush_power
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="BAL",
        contract_years=3,
        contract_total=60_000_000,
        contract_gtd=40_000_000,
        apy=20_000_000,
        age=31,
        overall_rating=85,
        strength=86,
        awareness=88,
        primary_attribute=89,  # pass_block
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="LAR",
        contract_years=3,
        contract_total=57_000_000,
        contract_gtd=35_000_000,
        apy=19_000_000,
        age=27,
        overall_rating=82,
        strength=85,
        awareness=80,
        primary_attribute=83,  # pass_block
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="NO",
        contract_years=3,
        contract_total=51_000_000,
        contract_gtd=30_000_000,
        apy=17_000_000,
        age=26,
        overall_rating=84,
        speed=86,
        strength=84,
        primary_attribute=85,  # pass_rush_power
    ),
    ...
    FreeAgentSigning(
        ...
        contract_years=3,
        contract_total=51_000_000,
        contract_gtd=32_000_000,
        apy=17_000_000,
        age=30,
        overall_rating=87,
        strength=90,
        awareness=86,
        primary_attribute=88,  # block_shed
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="IND",
        contract_years=3,
        contract_total=48_000_000,
        contract_gtd=28_000_000,
        apy=16_000_000,
        age=26,
        overall_rating=81,
        speed=84,
        strength=82,
        primary_attribute=83,  # pass_rush_finesse
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="NYJ",
        contract_years=3,
        contract_total=45_000_000,
        contract_gtd=27_000_000,
        apy=15_000_000,
        age=26,
        overall_rating=82,
        speed=82,
        awareness=84,
        primary_attribute=85,  # tackle
    ),
    ...
    FreeAgentSigning(
        ...
        speed=88,
        awareness=95,
        primary_attribute=97,  # route_running
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="ATL",
        contract_years=3,
        contract_total=43_500_000,
        contract_gtd=25_000_000,
        apy=14_500_000,
        age=31,
        overall_rating=85,
        strength=88,
        awareness=86,
        primary_attribute=86,  # block_shed
    ),
    ...
    FreeAgentSigning(
        ...
        speed=92,
        awareness=75,
        primary_attribute=78,  # throw_accuracy_mid
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="LV",
        contract_years=3,
        contract_total=37_000_000,
        contract_gtd=22_000_000,
        apy=12_333_333,
        age=29,
        overall_rating=80,
        speed=80,
        awareness=83,
        primary_attribute=82,  # tackle
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="LAC",
        contract_years=3,
        contract_total=36_000_000,
        contract_gtd=20_000_000,
        apy=12_000_000,
        age=26,
        overall_rating=79,
        speed=86,
        awareness=78,
        primary_attribute=80,  # catching
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="SF",
        contract_years=3,
        contract_total=31_500_000,
        contract_gtd=18_000_000,
        apy=10_500_000,
        age=28,
        overall_rating=82,
        speed=84,
        awareness=85,
        primary_attribute=84,  # tackle
    ),
    ...
    FreeAgentSigning(
        ...
        strength=84,
        awareness=79,
        primary_attribute=81,  # pass_block
    ),
    ...
    FreeAgentSigning(
        ...
        strength=87,
        awareness=84,
        primary_attribute=85,  # block_shed
    ),
    ...
    FreeAgentSigning(
        ...
        previous_team="NYJ",
        contract_years=1,
        contract_total=15_000_000,
        contract_gtd=15_000_000,
        apy=15_000_000,
        age=41,
        overall_rating=85,
        speed=72,
        awareness=97,
        primary_attribute=92,  # throw_accuracy_deep
    ),
    # Russell Wilson
    FreeAgentSigning(
        first_name="Russell",
        ...
        previous_team="PIT",
        contract_years=1,
        contract_total=10_500_000,
        contract_gtd=10_500_000,
        apy=10_500_000,
        age=36,
        overall_rating=80,
        speed=80,
        awareness=88,
        primary_attribute=85,  # throw_on_run
    ),
    # Aaron Jones
    FreeAgentSigning(
        first_name="Aaron",
        ...
        previous_team="MIN",
        contract_years=2,
        contract_total=20_000_000,
        contract_gtd=12_000_000,
        apy=10_000_000,
        age=30,
        overall_rating=84,
        speed=88,
        awareness=82,
        primary_attribute=86,  # agility
    ),
    # Khalil Mack
    FreeAgentSigning(
        first_name="Khalil",
        ...
        speed=82,
        strength=90,
        primary_attribute=92,  # pass_rush_power
    ),
    # Joey Bosa
    FreeAgentSigning(
        first_name="Joey",
        ...
        previous_team="LAC",
        contract_years=1,
        contract_total=12_600_000,
        contract_gtd=12_600_000,
        apy=12_600_000,
        age=30,
        overall_rating=85,
        speed=82,
        strength=87,
        primary_attribute=88,  # pass_rush_finesse
    ),
    # Haason Reddick
    FreeAgentSigning(
        first_name="Haason",
        ...
        previous_team="NYJ",
        contract_years=1,
        contract_total=14_000_000,
        contract_gtd=14_000_000,
        apy=14_000_000,
        age=31,
        overall_rating=84,
        speed=86,
        strength=82,
        primary_attribute=86,  # pass_rush_power
    ),
    # Nick Chubb
    FreeAgentSigning(
        first_name="Nick",
        ...
        previous_team="CLE",
        contract_years=1,
        contract_total=5_000_000,
        contract_gtd=5_000_000,
        apy=5_000_000,
        age=29,
        overall_rating=83,
        speed=85,
        strength=88,
        primary_attribute=90,  # break_tackle
    ),
    # Najee Harris
    FreeAgentSigning(
        first_name="Najee",
        ...
        previous_team="PIT",
        contract_years=1,
        contract_total=9_250_000,
        contract_gtd=6_000_000,
        apy=9_250_000,
        age=27,
        overall_rating=81,
        speed=84,
        strength=86,
        primary_attribute=85,  # break_tackle
    ),
]
...
if __name__ == "__main__":
    ...
    for i, fa in enumerate(get_top_free_agents(5), 1):
        print(
            f"  {i}. {fa.first_name} {fa.last_name} ({fa.position}) -> {fa.new_team}: ${fa.contract_total:,}"
        )
