...
PLAYER_ACCOMPLISHMENTS: dict[tuple, CareerAccolades] = {
    ("Patrick", "Mahomes"): CareerAccolades(
        pro_bowls=6,
        all_pros_1st=2,
        all_pros_2nd=1,
        mvps=2,
        super_bowl_mvps=3,
        offensive_player_of_year=1,
    ),
    ...
    ("Aaron", "Rodgers"): CareerAccolades(
        pro_bowls=10, all_pros_1st=4, all_pros_2nd=1, mvps=4, super_bowl_mvps=1
    ),
    ("Kirk", "Cousins"): CareerAccolades(pro_bowls=4),
    ("Matthew", "Stafford"): CareerAccolades(
        pro_bowls=2, super_bowl_mvps=0
    ),  # Getting respect for the ring
    ...
    # RBs
    ("Christian", "McCaffrey"): CareerAccolades(
        pro_bowls=3, all_pros_1st=2, all_pros_2nd=1, offensive_player_of_year=1
    ),
    ("Derrick", "Henry"): CareerAccolades(
        pro_bowls=4, all_pros_1st=1, all_pros_2nd=1, offensive_player_of_year=1
    ),
    ...
    ("Justin", "Jefferson"): CareerAccolades(
        pro_bowls=3, all_pros_1st=1, all_pros_2nd=2, offensive_player_of_year=1
    ),
    ("Ja'Marr", "Chase"): CareerAccolades(pro_bowls=3, all_pros_2nd=1, rookie_of_year=1),
    ("Cooper", "Kupp"): CareerAccolades(
        pro_bowls=1, all_pros_1st=1, offensive_player_of_year=1, super_bowl_mvps=1
    ),
    ...
    # DE/EDGE
    ("Myles", "Garrett"): CareerAccolades(
        pro_bowls=5, all_pros_1st=3, all_pros_2nd=1, defensive_player_of_year=1
    ),
    ("T.J.", "Watt"): CareerAccolades(
        pro_bowls=6, all_pros_1st=4, all_pros_2nd=1, defensive_player_of_year=1
    ),
    ("Nick", "Bosa"): CareerAccolades(
        pro_bowls=4, all_pros_1st=1, defensive_player_of_year=1, rookie_of_year=1
    ),
    ("Micah", "Parsons"): CareerAccolades(
        pro_bowls=3, all_pros_1st=2, all_pros_2nd=1, rookie_of_year=1
    ),
    ("Maxx", "Crosby"): CareerAccolades(pro_bowls=3, all_pros_2nd=2),
    ("Khalil", "Mack"): CareerAccolades(
        pro_bowls=8, all_pros_1st=3, all_pros_2nd=2, defensive_player_of_year=1
    ),
    ...
    ("Aaron", "Donald"): CareerAccolades(
        pro_bowls=10, all_pros_1st=8, defensive_player_of_year=3, rookie_of_year=1
    ),  # Respect the legend
