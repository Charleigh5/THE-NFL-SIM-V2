...
COACHES_DB: Dict[str, TeamCoachingStaff] = {
    ...
    "BUF": TeamCoachingStaff(
        ...
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=35, aggressiveness=65, tempo=55)
    ),
    "MIA": TeamCoachingStaff(
        ...
        philosophy=CoachingPhilosophy(run_pass_ratio=40, blitz_frequency=30, aggressiveness=60, tempo=75)
    ),
    "NE": TeamCoachingStaff(
        ...
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=50, blitz_frequency=25, aggressiveness=45, tempo=45)
    ),
    ...
    "BAL": TeamCoachingStaff(
        ...
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=60, blitz_frequency=45, aggressiveness=70, tempo=60)
    ),
    "CIN": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=35, blitz_frequency=30, aggressiveness=55, tempo=55)
    ),
    "CLE": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=55, blitz_frequency=25, aggressiveness=50, tempo=50)
    ),
    "PIT": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.POWER_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=55, blitz_frequency=50, aggressiveness=55, tempo=45)
    ),
    ...
    "HOU": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=35, aggressiveness=60, tempo=55)
    ),
    ...
    "JAX": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=40, blitz_frequency=35, aggressiveness=60, tempo=65)
    ),
    "TEN": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.POWER_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=55, blitz_frequency=30, aggressiveness=45, tempo=45)
    ),
    ...
    "LV": TeamCoachingStaff(
        ...
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=50, blitz_frequency=25, aggressiveness=55, tempo=70)
    ),
    "LAC": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.POWER_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=60, blitz_frequency=40, aggressiveness=60, tempo=45)
    ),
    ...
    "DAL": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=30, aggressiveness=50, tempo=50)
    ),
    "NYG": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=35, aggressiveness=55, tempo=55)
    ),
    ...
    "CHI": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=50, blitz_frequency=30, aggressiveness=65, tempo=60)
    ),
    ...
    "GB": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=30, aggressiveness=60, tempo=55)
    ),
    ...
    "ATL": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=50, blitz_frequency=40, aggressiveness=55, tempo=55)
    ),
    ...
    "NO": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=40, blitz_frequency=35, aggressiveness=60, tempo=60)
    ),
    "TB": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.WEST_COAST,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=50, aggressiveness=55, tempo=50)
    ),
    ...
    "LAR": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=30, aggressiveness=65, tempo=65)
    ),
    "SF": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.FOUR_THREE,
        philosophy=CoachingPhilosophy(run_pass_ratio=50, blitz_frequency=30, aggressiveness=60, tempo=55)
    ),
    "SEA": TeamCoachingStaff(
        ...
        playbook_offense=OffensiveScheme.ZONE_RUN,
        playbook_defense=DefensiveScheme.THREE_FOUR,
        philosophy=CoachingPhilosophy(run_pass_ratio=45, blitz_frequency=45, aggressiveness=55, tempo=55)
    ),
}
