...
class Player(Base):
    ...
    position: Mapped[str] = mapped_column(
        String, index=True
    )  # Using String for flexibility, validation in schema
    ...
    depth_chart_rank: Mapped[int] = mapped_column(
        Integer, default=999
    )  # Lower is better (starter = 1)
    ...
    def acceleration(self, value):
        if self.attributes:
            self.attributes.acceleration = value
    ...
    def awareness(self, value):
        if self.attributes:
            self.attributes.awareness = value
    ...
    def injury_resistance(self, value):
        if self.attributes:
            self.attributes.injury_resistance = value
    ...
    def forty_yard_dash(self, value):
        if self.attributes:
            self.attributes.forty_yard_dash = value
    ...
    def bench_press(self, value):
        if self.attributes:
            self.attributes.bench_press = value
    ...
    def vertical_jump(self, value):
        if self.attributes:
            self.attributes.vertical_jump = value
    ...
    def broad_jump(self, value):
        if self.attributes:
            self.attributes.broad_jump = value
    ...
    def three_cone_drill(self, value):
        if self.attributes:
            self.attributes.three_cone_drill = value
    ...
    def twenty_yard_shuttle(self, value):
        if self.attributes:
            self.attributes.twenty_yard_shuttle = value
    ...
    def power_clean_max(self, value):
        if self.attributes:
            self.attributes.power_clean_max = value
    ...
    def gps_speed_max(self, value):
        if self.attributes:
            self.attributes.gps_speed_max = value
    ...
    def s2_cognition_score(self, value):
        if self.attributes:
            self.attributes.s2_cognition_score = value
    ...
    def medical_flags(self, value):
        if self.injury:
            self.injury.medical_flags = value
    ...
    def genesis_revealed(self, value):
        if self.injury:
            self.injury.genesis_revealed = value
    ...
    def throw_power(self, value):
        if self.attributes:
            self.attributes.throw_power = value
    ...
    def throw_accuracy_short(self, value):
        if self.attributes:
            self.attributes.throw_accuracy_short = value
    ...
    def throw_accuracy_mid(self, value):
        if self.attributes:
            self.attributes.throw_accuracy_mid = value
    ...
    def throw_accuracy_deep(self, value):
        if self.attributes:
            self.attributes.throw_accuracy_deep = value
    ...
    def catching(self, value):
        if self.attributes:
            self.attributes.catching = value
    ...
    def route_running(self, value):
        if self.attributes:
            self.attributes.route_running = value
    ...
    def pass_block(self, value):
        if self.attributes:
            self.attributes.pass_block = value
    ...
    def run_block(self, value):
        if self.attributes:
            self.attributes.run_block = value
    ...
    def hit_power(self, value):
        if self.attributes:
            self.attributes.hit_power = value
    ...
    def block_shed(self, value):
        if self.attributes:
            self.attributes.block_shed = value
    ...
    def man_coverage(self, value):
        if self.attributes:
            self.attributes.man_coverage = value
    ...
    def zone_coverage(self, value):
        if self.attributes:
            self.attributes.zone_coverage = value
    ...
    def pass_rush_power(self, value):
        if self.attributes:
            self.attributes.pass_rush_power = value
    ...
    def pass_rush_finesse(self, value):
        if self.attributes:
            self.attributes.pass_rush_finesse = value
    ...
    def play_recognition(self, value):
        if self.attributes:
            self.attributes.play_recognition = value
    ...
    def kick_power(self, value):
        if self.attributes:
            self.attributes.kick_power = value
    ...
    def kick_accuracy(self, value):
        if self.attributes:
            self.attributes.kick_accuracy = value

    # --- Proposed Enhancements (Proxied to PlayerAttributes) ---
    @hybrid_property
    ...
    def pocket_presence(self, value):
        if self.attributes:
            self.attributes.pocket_presence = value
    ...
    def quick_release(self, value):
        if self.attributes:
            self.attributes.quick_release = value
    ...
    def scramble_willingness(self, value):
        if self.attributes:
            self.attributes.scramble_willingness = value
    ...
    def throw_on_run(self, value):
        if self.attributes:
            self.attributes.throw_on_run = value
    ...
    def patience(self, value):
        if self.attributes:
            self.attributes.patience = value
    ...
    def pass_pro_rating(self, value):
        if self.attributes:
            self.attributes.pass_pro_rating = value
    ...
    def juke_efficiency(self, value):
        if self.attributes:
            self.attributes.juke_efficiency = value
    ...
    def blocking_tenacity(self, value):
        if self.attributes:
            self.attributes.blocking_tenacity = value
    ...
    def pull_speed(self, value):
        if self.attributes:
            self.attributes.pull_speed = value
    ...
    def discipline(self, value):
        if self.attributes:
            self.attributes.discipline = value
    ...
    def first_step(self, value):
        if self.attributes:
            self.attributes.first_step = value
    ...
    def gap_integrity(self, value):
        if self.attributes:
            self.attributes.gap_integrity = value
    ...
    def coverage_disguise(self, value):
        if self.attributes:
            self.attributes.coverage_disguise = value
    ...
    def blitz_timing(self, value):
        if self.attributes:
            self.attributes.blitz_timing = value
    ...
    def ball_tracking(self, value):
        if self.attributes:
            self.attributes.ball_tracking = value
    ...
    def run_support(self, value):
        if self.attributes:
            self.attributes.run_support = value
    ...
    def hang_time(self, value):
        if self.attributes:
            self.attributes.hang_time = value
    ...
    def coffin_corner(self, value):
        if self.attributes:
            self.attributes.coffin_corner = value
    ...
    def return_vision(self, value):
        if self.attributes:
            self.attributes.return_vision = value
    ...
    def release_point_height(self, value):
        if self.physics:
            self.physics.release_point_height = value
    ...
    def vision_cone_angle(self, value):
        if self.physics:
            self.physics.vision_cone_angle = value
    ...
    def break_tackle_threshold(self, value):
        if self.physics:
            self.physics.break_tackle_threshold = value
    ...
    def skill_points(self, value):
        if self.progression:
            self.progression.skill_points = value
    ...
    def development_trait(self, value):
        if self.progression:
            self.progression.development_trait = value
    ...
    def abilities(self, value):
        if self.progression:
            self.progression.abilities = value
    ...
    def attribute_xp(self, value):
        if self.progression:
            self.progression.attribute_xp = value
    ...
    def injury_status(self, value):
        if self.injury:
            self.injury.injury_status = value
    ...
    def weeks_to_recovery(self, value):
        if self.injury:
            self.injury.weeks_to_recovery = value
    ...
    def injury_severity(self, value):
        if self.injury:
            self.injury.injury_severity = value
    ...
    def injury_recurrence_risk(self, value):
        if self.injury:
            self.injury.injury_recurrence_risk = value
    ...
    def contract_years(self, value):
        if self.contract:
            self.contract.contract_years = value
    ...
    def contract_salary(self, value):
        if self.contract:
            self.contract.contract_salary = value
    ...
    def is_retired(self, value):
        if self.contract:
            self.contract.is_retired = value
    ...
    def retirement_year(self, value):
        if self.contract:
            self.contract.retirement_year = value
    ...
    def legacy_score(self, value):
        if self.contract:
            self.contract.legacy_score = value
    ...
    game_starts: Mapped[list[PlayerGameStarts]] = relationship(
        "PlayerGameStarts", back_populates="player"
    )
    ...
    attributes: Mapped[PlayerAttributes] = relationship(
        "PlayerAttributes", back_populates="player", uselist=False, lazy="joined"
    )
    contract: Mapped[PlayerContract] = relationship(
        "PlayerContract", back_populates="player", uselist=False, lazy="joined"
    )
    physics: Mapped[PlayerPhysics] = relationship(
        "PlayerPhysics", back_populates="player", uselist=False, lazy="joined"
    )
    injury: Mapped[PlayerInjury] = relationship(
        "PlayerInjury", back_populates="player", uselist=False, lazy="joined"
    )
    progression: Mapped[PlayerProgression] = relationship(
        "PlayerProgression", back_populates="player", uselist=False, lazy="joined"
    )
