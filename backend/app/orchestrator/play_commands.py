...
class PassPlayCommand(PlayCommand):
    ...
    def __init__(self, offense_players: List[Any], defense_players: List[Any],
                 ...
                 distance: int = 10, down: int = 1, yard_line: int = 20, possession: str = "home"):
        super().__init__(offense_players, defense_players, modifiers, play_id, distance, down, yard_line, possession=possession)
