...
@pytest.mark.asyncio
async def test_draft_suggest_pick_endpoint(async_client: AsyncClient, async_db_session):
...
@pytest.mark.asyncio
async def test_draft_assistant_roster_gap_analysis(async_client: AsyncClient, async_db_session):
...
@pytest.mark.asyncio
async def test_draft_value_score_calculation(async_client: AsyncClient, async_db_session):
...
@pytest.mark.asyncio
async def test_draft_assistant_error_handling(async_client: AsyncClient, async_db_session):
...
@pytest.mark.asyncio
async def test_alternative_picks_quality(async_client: AsyncClient, async_db_session):
