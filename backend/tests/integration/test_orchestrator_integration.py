...
def test_orchestrator_integration_flow(mock_session_local):
    ...
    # Verify new statistical realism features
    ...
    # Test new advanced play calling with Cortex integration
    assert orchestrator.match_context.cortex is not None
    assert isinstance(orchestrator.match_context.cortex, CortexKernel)
