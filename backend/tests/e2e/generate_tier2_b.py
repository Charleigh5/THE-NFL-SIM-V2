# Generator for Tier 2 Part B (F16 - F31 Boundaries)
import os
...
if __name__ == '__main__':
    ...
    with open(os.path.join(e2e_dir, 'part4_tier2_b.py'), 'w', encoding='utf-8') as f:
        f.write(TIER2_B_CODE)
    print('Generated part4_tier2_b.py in e2e dir')
