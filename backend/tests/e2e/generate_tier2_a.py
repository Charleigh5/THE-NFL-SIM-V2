# Generator for Tier 2 Part A (F01 - F15 Boundaries)
import os
...
if __name__ == '__main__':
    ...
    with open(os.path.join(e2e_dir, 'part3_tier2_a.py'), 'w', encoding='utf-8') as f:
        f.write(TIER2_A_CODE)
    print('Generated part3_tier2_a.py in e2e dir')
