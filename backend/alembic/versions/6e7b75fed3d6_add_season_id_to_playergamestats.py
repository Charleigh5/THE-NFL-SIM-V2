...
def upgrade() -> None:
    ...
    # (Checking if it exists is hard in migration, but we can assume it wasn't created yet based on error)
    # Actually, if we look at other migrations, stadium table was NEVER created.
