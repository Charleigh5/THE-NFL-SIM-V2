...
def upgrade() -> None:
    ...
    with op.batch_alter_table('team', schema=None) as batch_op:
        # Check if stadium table exists before adding constraint or handle gracefully
        # Commenting out for now as the stadium table might be missing in this migration context
