"""add_season_id_to_playergamestats_and_stadium
...
def upgrade() -> None:
    ...
    # 1. Create Stadium Table (Missing in previous migrations)
    ...
    # 2. Add season_id to playergamestats (Original purpose)
    ...
    # 3. Add stadium_id to team and link it
